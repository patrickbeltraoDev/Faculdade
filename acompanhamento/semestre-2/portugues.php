                ...
                <div class="select">
                    ...
                    <div class="check">
                        <label for="tema1" class="label-buttom">
                            <span>Linguagem e Língua: Conceitos</span>
                ...
                <div class="select">
                    ...
                    <div class="check">
                        <label for="tema2" class="label-buttom">
                            <span>Norma Culta e Variação Linguística</span>
                            <div class="box-buttom">
                ...
                <div class="select">
                    ...
                    <div class="check">
                        <label for="tema4" class="label-buttom">
                            <span>Dificuldades Gramaticais Mais Comuns</span>
                            <div class="box-buttom">
                ...
                <div class="select">
                    ...
                    <div class="check">
                        <label for="tema5" class="label-buttom">
                            <span>A Língua no Ambiente Profissional</span>
                            <div class="box-buttom">
